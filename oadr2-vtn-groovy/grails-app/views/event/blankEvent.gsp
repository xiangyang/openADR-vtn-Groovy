...
<body>
  ...
  <div class="input-append bootstrap-timepicker">			  
			<label>Start Time: </label><g:textField name="startTime" value="${time}" class="input-small" id="tp" />	
            <span class="add-on"><i class="icon-time"></i></span>
        </div>			
			<label>End Date: </label><g:textField name="endDate" value="${date}"  class="dp"/>	
  <div class="input-append bootstrap-timepicker">			  
			<label>End Time: </label><g:textField name="endTime" value="${time}" class="input-small" id="tp1" />	
            <span class="add-on"><i class="icon-time"></i></span>
        </div>	
        <div class="actions">
